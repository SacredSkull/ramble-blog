 ...
 * @method     ChildTagQuery orderBySlug($order = Criteria::ASC) Order by the slug column
 *
 * @method     ChildTagQuery groupById() Group by the id column
 * @method     ChildTagQuery groupByName() Group by the name column
 * @method     ChildTagQuery groupBySlug() Group by the slug column
 *
 ...
 *
 * @method     ChildTagQuery leftJoinArticle($relationAlias = null) Adds a LEFT JOIN clause to the query using the Article relation
 ...
 * @method     ChildTag findOneBySlug(string $slug) Return the first ChildTag filtered by the slug column *
 ...
 * @method     ChildTag requireOneBySlug(string $slug) Return the first ChildTag filtered by the slug column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildTag[]|ObjectCollection findBySlug(string $slug) Return ChildTag objects filtered by the slug column
...
abstract class TagQuery extends ModelCriteria
{
    ...
    public function filterBySlug($slug = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TagTableMap::COL_SLUG, $slug, $comparison);
    }
    ...
    public function filterByArticle($article, $comparison = null)
    {
        if ($article instanceof \Article) {
            return $this
                ->addUsingAlias(TagTableMap::COL_ID, $article->getTagId(), $comparison);
