<html lang="en">
	<head>
		...
		<link href='{{ baseUrl() }}/include/css/nanoscroller.css' rel='stylesheet' type='text/css'>
		<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="{{ baseUrl() }}/wlwmanifest.xml" />
		<link rel="stylesheet" type="text/css" href="{{ baseUrl() }}/include/css/jquery.mCustomScrollbar.min.css">
		{% endblock head %}
		<style type="text/css">
		...
		<!--[if lte IE 8]>
			<link rel="stylesheet" href="{{ baseUrl() }}/css/layouts/minimal-styles-old-ie.css">
		<![endif]-->
		<!--[if gt IE 8]><!-->
			{%if wireframe%}<link href='{{ baseUrl() }}/include/css/minimal-wireframe.css' rel='stylesheet/css' type='text/css'>{%else%}<link href='{{ baseUrl() }}/include/css/minimal-styles.css' rel='stylesheet' type='text/css'>{%endif%}
		<!--<![endif]-->
	...
	<body>
		<div id="layout" class="pure-g">
			<div class="sidebar pure-u-1 pure-u-md-1-4">
				<div class="header">
					<img id="skull" class="pure-img-responsive" src="{{ baseUrl() }}/include/img/skull.svg" onerror="this.src='/include/img/skull.png'"></img>
				...
				<div>
					...
					<div class="posts">
						...
						<section class="post">
							<header class="post-header">
								<img class="post-avatar" alt="Post's image" src="{{ baseUrl() }}/include/img/edit.png" height="48" width="48">
								...
								<p class="post-meta">
									<a href="{{ baseUrl() }}/category/{{post.getCategory.getSlug}}" style="//color: {{post.getCategory.getColour}};" class="post-category">{{post.getCategory.getName}}</a>
					...
					<div class="footer">
                        ...
                        <div class="pure-menu pure-menu-horizontal">
                            <ul>
                                <li class="pure-menu-item{% if current_page == 1 %} disabled{% endif %}"><a class="pure-menu-link" href="{{ baseUrl() }}/{{pagination_url|default('/page/')}}1">&laquo;</a></li>
                            {% for page in page_list %}
                                <li class="pure-menu-item{% if current_page == page %} active{% endif %}"><a class="pure-menu-link" href="{{ baseUrl() }}/{{pagination_url|default('/page/')}}{{page}}">{{page}}</a></li>
                            {% endfor %}
                                <li class="pure-menu-item{% if max_pages == current_page %} disabled{% endif %}"><a class="pure-menu-link" href="{{ baseUrl() }}/{{pagination_url|default('/page/')}}{{max_pages}}">&raquo;</a></li>
                            </ul>
                        </div>
                        {% endif %}
						<div class="pure-menu pure-menu-horizontal">
		...
		<script type="text/javascript" src="{{ baseUrl() }}/include/js/minimal/out/all.min.js"></script>
